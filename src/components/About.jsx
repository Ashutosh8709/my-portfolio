...
export default function About() {
  ...
  return (
    <section
      id="home"
      className="py-4 px-[7vw] md:px-[7vw] lg:px-[7vw] font-sans mt-24 md:mt-35 lg:mt-30 scroll-mt-30"
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-[50%] lg:w-[60%] text-center md:text-left mt-8 md:mt-10">
          ...
          <motion.a
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0 }}
            href="https://www.linkedin.com/in/ashutoshkumarak9/"
            target="_blank"
          ...
          <motion.a
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0 }}
            href="https://github.com/Ashutosh8709"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <div className="mt-6">
            <motion.a
              ...
              whileInView="show"
              viewport={{ once: true, amount: 0 }}
              href="https://drive.google.com/file/d/1HzDTS6yugYE2r7IwOHt8TBgbwlhKsCn9/view?usp=sharing"
              target="_blank"
        ...
        >
          <Tilt
            className=" w-48 h-48 sm:w-60 sm:h-60 md:w-90 md:h-90 lg:w-135 lg:h-135 border-3 border-purple-500 rounded-full"
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.051}
          ...
          >
            <img
              src={profileImage}
              alt="Ashutosh Kumar"
              className="h-48 w-48 sm:w-60 sm:h-60  md:w-90 md:h-90 lg:w-135 lg:h-135  rounded-full object-cover drop-shadow-[0_10px_20px_rgba(168,85,247,0.5)]"
            />
          </Tilt>
        </motion.div>
      </div>
